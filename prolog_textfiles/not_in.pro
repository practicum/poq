...
type_one_table(L) :-
        ...
        type_one_table_with_constraints(L,t,L).


type_one_table_with_constraints([],_ASSOC,[]).
...
type_one_table_with_constraints(
  ...
  OUT) :-
        ...
        type_one_table_with_constraints(LT,MAP,OUT). % note: here, the OUT (output) does NOT include the head item.
...
type_one_table_with_constraints(
  ...
  [(T01)   |REST]) :-
        ...
        type_one_table_with_constraints(LT,MAP2,REST).
...
type_two_table(L) :-
        % t is the empty mapping, from library assoc
        type_two_table_with_constraints(L,t,L).


type_two_table_with_constraints([],_ASSOC,[]).
...
type_two_table_with_constraints(
  ...
  OUT) :-
        ...
        type_two_table_with_constraints(LT,MAP,OUT). % note: here, the OUT (output) does NOT include the head item.
...
type_two_table_with_constraints(
  ...
  [(T02)   |REST]) :-
        ...
        type_two_table_with_constraints(LT,MAP2,REST).
