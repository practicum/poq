...
static void yy_destructor(
  ...
  switch( yymajor ){
    ...
    */
    ...
    case 194: /* oneselect */
{
#line 404 "sql_parse.y"
sqlite3SelectDelete(pParse->db, (yypminor->yy387));
#line 1393 "sql_parse.c"
}
      break;
    case 174: /* term */
    case 175: /* expr */
{
#line 721 "sql_parse.y"
sqlite3ExprDelete(pParse->db, (yypminor->yy118).pExpr);
#line 1401 "sql_parse.c"
}
      break;
...
{
#line 1104 "sql_parse.y"
sqlite3ExprListDelete(pParse->db, (yypminor->yy322));
#line 1419 "sql_parse.c"
}
      break;
    case 193: /* fullname */
    case 198: /* from */
    ...
    case 207: /* stl_prefix */
{
#line 535 "sql_parse.y"
sqlite3SrcListDelete(pParse->db, (yypminor->yy259));
#line 1429 "sql_parse.c"
}
      break;
    case 199: /* where_opt */
    case 201: /* having_opt */
    ...
    case 243: /* key_opt */
{
#line 645 "sql_parse.y"
sqlite3ExprDelete(pParse->db, (yypminor->yy314));
#line 1443 "sql_parse.c"
}
      break;
    case 211: /* using_opt */
    case 213: /* inscollist */
...
{
#line 567 "sql_parse.y"
sqlite3IdListDelete(pParse->db, (yypminor->yy384));
#line 1452 "sql_parse.c"
}
      break;
    case 234: /* trigger_cmd_list */
    case 239: /* trigger_cmd */
{
#line 1211 "sql_parse.y"
sqlite3DeleteTriggerStep(pParse->db, (yypminor->yy203));
#line 1460 "sql_parse.c"
}
      break;
    case 236: /* trigger_event */
{
#line 1197 "sql_parse.y"
sqlite3IdListDelete(pParse->db, (yypminor->yy90).b);
#line 1467 "sql_parse.c"
}
      break;
...
static void yy_reduce(
  ...
  */
      case 5: /* explain ::= */
#line 105 "sql_parse.y"
{ sqlite3BeginParse(pParse, 0); }
#line 2096 "sql_parse.c"
        break;
      case 6: /* explain ::= EXPLAIN */
#line 107 "sql_parse.y"
{ sqlite3BeginParse(pParse, 1); }
#line 2101 "sql_parse.c"
        break;
      case 7: /* explain ::= EXPLAIN QUERY PLAN */
#line 108 "sql_parse.y"
{ sqlite3BeginParse(pParse, 2); }
#line 2106 "sql_parse.c"
        break;
      case 8: /* cmdx ::= cmd */
#line 110 "sql_parse.y"
{ sqlite3FinishCoding(pParse); }
#line 2111 "sql_parse.c"
        break;
      case 9: /* cmd ::= BEGIN transtype trans_opt */
#line 115 "sql_parse.y"
{sqlite3BeginTransaction(pParse, yymsp[-1].minor.yy4);}
#line 2116 "sql_parse.c"
        break;
      case 13: /* transtype ::= */
#line 120 "sql_parse.y"
{yygotominor.yy4 = TK_DEFERRED;}
#line 2121 "sql_parse.c"
        break;
...
#line 121 "sql_parse.y"
{yygotominor.yy4 = yymsp[0].major;}
#line 2130 "sql_parse.c"
        break;
      case 17: /* cmd ::= COMMIT trans_opt */
      case 18: /* cmd ::= END trans_opt */ yytestcase(yyruleno==18);
#line 124 "sql_parse.y"
{sqlite3CommitTransaction(pParse);}
#line 2136 "sql_parse.c"
        break;
      case 19: /* cmd ::= ROLLBACK trans_opt */
#line 126 "sql_parse.y"
{sqlite3RollbackTransaction(pParse);}
#line 2141 "sql_parse.c"
        break;
      case 22: /* cmd ::= SAVEPOINT nm */
#line 130 "sql_parse.y"
{
  sqlite3Savepoint(pParse, SAVEPOINT_BEGIN, &yymsp[0].minor.yy0);
}
#line 2148 "sql_parse.c"
        break;
      case 23: /* cmd ::= RELEASE savepoint_opt nm */
#line 133 "sql_parse.y"
{
  sqlite3Savepoint(pParse, SAVEPOINT_RELEASE, &yymsp[0].minor.yy0);
}
#line 2155 "sql_parse.c"
        break;
      case 24: /* cmd ::= ROLLBACK trans_opt TO savepoint_opt nm */
#line 136 "sql_parse.y"
{
  sqlite3Savepoint(pParse, SAVEPOINT_ROLLBACK, &yymsp[0].minor.yy0);
}
#line 2162 "sql_parse.c"
        break;
      case 26: /* create_table ::= createkw temp TABLE ifnotexists nm dbnm */
#line 143 "sql_parse.y"
{
   sqlite3StartTable(pParse,&yymsp[-1].minor.yy0,&yymsp[0].minor.yy0,yymsp[-4].minor.yy4,0,0,yymsp[-2].minor.yy4);
}
#line 2169 "sql_parse.c"
        break;
      case 27: /* createkw ::= CREATE */
#line 146 "sql_parse.y"
{
  pParse->db->lookaside.bEnabled = 0;
  yygotominor.yy0 = yymsp[0].minor.yy0;
}
#line 2177 "sql_parse.c"
        break;
      case 28: /* ifnotexists ::= */
...
#line 151 "sql_parse.y"
{yygotominor.yy4 = 0;}
#line 2193 "sql_parse.c"
        break;
...
#line 152 "sql_parse.y"
{yygotominor.yy4 = 1;}
#line 2205 "sql_parse.c"
        break;
      case 32: /* create_table_args ::= LP columnlist conslist_opt RP */
#line 158 "sql_parse.y"
{
  sqlite3EndTable(pParse,&yymsp[-1].minor.yy0,&yymsp[0].minor.yy0,0);
}
#line 2212 "sql_parse.c"
        break;
      case 33: /* create_table_args ::= AS select */
#line 161 "sql_parse.y"
{
  sqlite3EndTable(pParse,0,0,yymsp[0].minor.yy387);
  sqlite3SelectDelete(pParse->db, yymsp[0].minor.yy387);
}
#line 2220 "sql_parse.c"
        break;
      case 36: /* column ::= columnid type carglist */
#line 173 "sql_parse.y"
{
  yygotominor.yy0.z = yymsp[-2].minor.yy0.z;
  yygotominor.yy0.n = (int)(pParse->sLastToken.z-yymsp[-2].minor.yy0.z) + pParse->sLastToken.n;
}
#line 2228 "sql_parse.c"
        break;
      case 37: /* columnid ::= nm */
#line 177 "sql_parse.y"
{
  sqlite3AddColumn(pParse,&yymsp[0].minor.yy0);
  yygotominor.yy0 = yymsp[0].minor.yy0;
}
#line 2236 "sql_parse.c"
        break;
      case 38: /* id ::= ID */
...
#line 187 "sql_parse.y"
{yygotominor.yy0 = yymsp[0].minor.yy0;}
#line 2262 "sql_parse.c"
        break;
      case 45: /* type ::= typetoken */
#line 249 "sql_parse.y"
{sqlite3AddColumnType(pParse,&yymsp[0].minor.yy0);}
#line 2267 "sql_parse.c"
        break;
      case 47: /* typetoken ::= typename LP signed RP */
#line 251 "sql_parse.y"
{
  yygotominor.yy0.z = yymsp[-3].minor.yy0.z;
  yygotominor.yy0.n = (int)(&yymsp[0].minor.yy0.z[yymsp[0].minor.yy0.n] - yymsp[-3].minor.yy0.z);
}
#line 2275 "sql_parse.c"
        break;
      case 48: /* typetoken ::= typename LP signed COMMA signed RP */
#line 255 "sql_parse.y"
{
  yygotominor.yy0.z = yymsp[-5].minor.yy0.z;
  yygotominor.yy0.n = (int)(&yymsp[0].minor.yy0.z[yymsp[0].minor.yy0.n] - yymsp[-5].minor.yy0.z);
}
#line 2283 "sql_parse.c"
        break;
      case 50: /* typename ::= typename ids */
#line 261 "sql_parse.y"
{yygotominor.yy0.z=yymsp[-1].minor.yy0.z; yygotominor.yy0.n=yymsp[0].minor.yy0.n+(int)(yymsp[0].minor.yy0.z-yymsp[-1].minor.yy0.z);}
#line 2288 "sql_parse.c"
        break;
      case 57: /* ccons ::= DEFAULT term */
      case 59: /* ccons ::= DEFAULT PLUS term */ yytestcase(yyruleno==59);
#line 272 "sql_parse.y"
{sqlite3AddDefaultValue(pParse,&yymsp[0].minor.yy118);}
#line 2294 "sql_parse.c"
        break;
      case 58: /* ccons ::= DEFAULT LP expr RP */
#line 273 "sql_parse.y"
{sqlite3AddDefaultValue(pParse,&yymsp[-1].minor.yy118);}
#line 2299 "sql_parse.c"
        break;
      case 60: /* ccons ::= DEFAULT MINUS term */
#line 275 "sql_parse.y"
{
  ExprSpan v;
...
#line 2310 "sql_parse.c"
        break;
      case 61: /* ccons ::= DEFAULT id */
#line 282 "sql_parse.y"
{
  ExprSpan v;
  spanExpr(&v, pParse, TK_STRING, &yymsp[0].minor.yy0);
  sqlite3AddDefaultValue(pParse,&v);
}
#line 2319 "sql_parse.c"
        break;
      case 63: /* ccons ::= NOT NULL onconf */
#line 292 "sql_parse.y"
{sqlite3AddNotNull(pParse, yymsp[0].minor.yy4);}
#line 2324 "sql_parse.c"
        break;
      case 64: /* ccons ::= PRIMARY KEY sortorder onconf autoinc */
#line 294 "sql_parse.y"
{sqlite3AddPrimaryKey(pParse,0,yymsp[-1].minor.yy4,yymsp[0].minor.yy4,yymsp[-2].minor.yy4);}
#line 2329 "sql_parse.c"
        break;
      case 65: /* ccons ::= UNIQUE onconf */
#line 295 "sql_parse.y"
{sqlite3CreateIndex(pParse,0,0,0,0,yymsp[0].minor.yy4,0,0,0,0);}
#line 2334 "sql_parse.c"
        break;
      case 66: /* ccons ::= CHECK LP expr RP */
#line 296 "sql_parse.y"
{sqlite3AddCheckConstraint(pParse,yymsp[-1].minor.yy118.pExpr);}
#line 2339 "sql_parse.c"
        break;
      case 67: /* ccons ::= REFERENCES nm idxlist_opt refargs */
#line 298 "sql_parse.y"
{sqlite3CreateForeignKey(pParse,0,&yymsp[-2].minor.yy0,yymsp[-1].minor.yy322,yymsp[0].minor.yy4);}
#line 2344 "sql_parse.c"
        break;
      case 68: /* ccons ::= defer_subclause */
#line 299 "sql_parse.y"
{sqlite3DeferForeignKey(pParse,yymsp[0].minor.yy4);}
#line 2349 "sql_parse.c"
        break;
      case 69: /* ccons ::= COLLATE ids */
#line 300 "sql_parse.y"
{sqlite3AddCollateType(pParse, &yymsp[0].minor.yy0);}
#line 2354 "sql_parse.c"
        break;
      case 72: /* refargs ::= */
#line 313 "sql_parse.y"
{ yygotominor.yy4 = OE_None*0x0101; /* EV: R-19803-45884 */}
#line 2359 "sql_parse.c"
        break;
      case 73: /* refargs ::= refargs refarg */
#line 314 "sql_parse.y"
{ yygotominor.yy4 = (yymsp[-1].minor.yy4 & ~yymsp[0].minor.yy215.mask) | yymsp[0].minor.yy215.value; }
#line 2364 "sql_parse.c"
        break;
      case 74: /* refarg ::= MATCH nm */
      case 75: /* refarg ::= ON INSERT refact */ yytestcase(yyruleno==75);
#line 316 "sql_parse.y"
{ yygotominor.yy215.value = 0;     yygotominor.yy215.mask = 0x000000; }
#line 2370 "sql_parse.c"
        break;
      case 76: /* refarg ::= ON DELETE refact */
#line 318 "sql_parse.y"
{ yygotominor.yy215.value = yymsp[0].minor.yy4;     yygotominor.yy215.mask = 0x0000ff; }
#line 2375 "sql_parse.c"
        break;
      case 77: /* refarg ::= ON UPDATE refact */
#line 319 "sql_parse.y"
{ yygotominor.yy215.value = yymsp[0].minor.yy4<<8;  yygotominor.yy215.mask = 0x00ff00; }
#line 2380 "sql_parse.c"
        break;
      case 78: /* refact ::= SET NULL */
#line 321 "sql_parse.y"
{ yygotominor.yy4 = OE_SetNull;  /* EV: R-33326-45252 */}
#line 2385 "sql_parse.c"
        break;
      case 79: /* refact ::= SET DEFAULT */
#line 322 "sql_parse.y"
{ yygotominor.yy4 = OE_SetDflt;  /* EV: R-33326-45252 */}
#line 2390 "sql_parse.c"
        break;
      case 80: /* refact ::= CASCADE */
#line 323 "sql_parse.y"
{ yygotominor.yy4 = OE_Cascade;  /* EV: R-33326-45252 */}
#line 2395 "sql_parse.c"
        break;
      case 81: /* refact ::= RESTRICT */
#line 324 "sql_parse.y"
{ yygotominor.yy4 = OE_Restrict; /* EV: R-33326-45252 */}
#line 2400 "sql_parse.c"
        break;
      case 82: /* refact ::= NO ACTION */
#line 325 "sql_parse.y"
{ yygotominor.yy4 = OE_None;     /* EV: R-33326-45252 */}
#line 2405 "sql_parse.c"
        break;
      case 84: /* defer_subclause ::= DEFERRABLE init_deferred_pred_opt */
      case 99: /* defer_subclause_opt ::= defer_subclause */ yytestcase(yyruleno==99);
      case 101: /* onconf ::= ON CONFLICT resolvetype */ yytestcase(yyruleno==101);
      case 104: /* resolvetype ::= raisetype */ yytestcase(yyruleno==104);
#line 328 "sql_parse.y"
{yygotominor.yy4 = yymsp[0].minor.yy4;}
#line 2413 "sql_parse.c"
        break;
      case 88: /* conslist_opt ::= */
#line 337 "sql_parse.y"
{yygotominor.yy0.n = 0; yygotominor.yy0.z = 0;}
#line 2418 "sql_parse.c"
        break;
      case 89: /* conslist_opt ::= COMMA conslist */
#line 338 "sql_parse.y"
{yygotominor.yy0 = yymsp[-1].minor.yy0;}
#line 2423 "sql_parse.c"
        break;
      case 94: /* tcons ::= PRIMARY KEY LP idxlist autoinc RP onconf */
#line 344 "sql_parse.y"
{sqlite3AddPrimaryKey(pParse,yymsp[-3].minor.yy322,yymsp[0].minor.yy4,yymsp[-2].minor.yy4,0);}
#line 2428 "sql_parse.c"
        break;
      case 95: /* tcons ::= UNIQUE LP idxlist RP onconf */
#line 346 "sql_parse.y"
{sqlite3CreateIndex(pParse,0,0,0,yymsp[-2].minor.yy322,yymsp[0].minor.yy4,0,0,0,0);}
#line 2433 "sql_parse.c"
        break;
      case 96: /* tcons ::= CHECK LP expr RP onconf */
#line 348 "sql_parse.y"
{sqlite3AddCheckConstraint(pParse,yymsp[-2].minor.yy118.pExpr);}
#line 2438 "sql_parse.c"
        break;
      case 97: /* tcons ::= FOREIGN KEY LP idxlist RP REFERENCES nm idxlist_opt refargs defer_subclause_opt */
#line 350 "sql_parse.y"
{
    sqlite3CreateForeignKey(pParse, yymsp[-6].minor.yy322, &yymsp[-3].minor.yy0, yymsp[-2].minor.yy322, yymsp[-1].minor.yy4);
    sqlite3DeferForeignKey(pParse, yymsp[0].minor.yy4);
}
#line 2446 "sql_parse.c"
        break;
      case 100: /* onconf ::= */
#line 364 "sql_parse.y"
{yygotominor.yy4 = OE_Default;}
#line 2451 "sql_parse.c"
        break;
      case 102: /* orconf ::= */
#line 366 "sql_parse.y"
{yygotominor.yy210 = OE_Default;}
#line 2456 "sql_parse.c"
        break;
      case 103: /* orconf ::= OR resolvetype */
#line 367 "sql_parse.y"
{yygotominor.yy210 = (u8)yymsp[0].minor.yy4;}
#line 2461 "sql_parse.c"
        break;
      case 105: /* resolvetype ::= IGNORE */
#line 369 "sql_parse.y"
{yygotominor.yy4 = OE_Ignore;}
#line 2466 "sql_parse.c"
        break;
      case 106: /* resolvetype ::= REPLACE */
#line 370 "sql_parse.y"
{yygotominor.yy4 = OE_Replace;}
#line 2471 "sql_parse.c"
        break;
      case 107: /* cmd ::= DROP TABLE ifexists fullname */
#line 374 "sql_parse.y"
{
  sqlite3DropTable(pParse, yymsp[0].minor.yy259, 0, yymsp[-1].minor.yy4);
}
#line 2478 "sql_parse.c"
        break;
      case 110: /* cmd ::= createkw temp VIEW ifnotexists nm dbnm AS select */
#line 384 "sql_parse.y"
{
...
#line 2485 "sql_parse.c"
        break;
      case 111: /* cmd ::= DROP VIEW ifexists fullname */
#line 387 "sql_parse.y"
{
  sqlite3DropTable(pParse, yymsp[0].minor.yy259, 1, yymsp[-1].minor.yy4);
}
#line 2492 "sql_parse.c"
        break;
      case 112: /* cmd ::= select */
#line 394 "sql_parse.y"
{
...
#line 2504 "sql_parse.c"
        break;
      case 113: /* select ::= oneselect */
#line 408 "sql_parse.y"
{yygotominor.yy387 = yymsp[0].minor.yy387;}
#line 2509 "sql_parse.c"
        break;
      case 114: /* select ::= select multiselect_op oneselect */
#line 410 "sql_parse.y"
{
...
#line 2522 "sql_parse.c"
        break;
      case 116: /* multiselect_op ::= UNION ALL */
#line 421 "sql_parse.y"
{yygotominor.yy4 = TK_ALL;}
#line 2527 "sql_parse.c"
        break;
      case 118: /* oneselect ::= SELECT distinct selcollist from where_opt groupby_opt having_opt orderby_opt limit_opt */
#line 425 "sql_parse.y"
{
  yygotominor.yy387 = sqlite3SelectNew(pParse,yymsp[-6].minor.yy322,yymsp[-5].minor.yy259,yymsp[-4].minor.yy314,yymsp[-3].minor.yy322,yymsp[-2].minor.yy314,yymsp[-1].minor.yy322,yymsp[-7].minor.yy4,yymsp[0].minor.yy292.pLimit,yymsp[0].minor.yy292.pOffset);
}
#line 2534 "sql_parse.c"
        break;
      case 122: /* sclp ::= selcollist COMMA */
      case 247: /* idxlist_opt ::= LP idxlist RP */ yytestcase(yyruleno==247);
#line 446 "sql_parse.y"
{yygotominor.yy322 = yymsp[-1].minor.yy322;}
#line 2540 "sql_parse.c"
        break;
      case 123: /* sclp ::= */
...
#line 447 "sql_parse.y"
{yygotominor.yy322 = 0;}
#line 2549 "sql_parse.c"
        break;
      case 124: /* selcollist ::= sclp expr as */
#line 448 "sql_parse.y"
{
   yygotominor.yy322 = sqlite3ExprListAppend(pParse, yymsp[-2].minor.yy322, yymsp[-1].minor.yy118.pExpr);
   if( yymsp[0].minor.yy0.n>0 ) sqlite3ExprListSetName(pParse, yygotominor.yy322, &yymsp[0].minor.yy0, 1);
   sqlite3ExprListSetSpan(pParse,yygotominor.yy322,&yymsp[-1].minor.yy118);
}
#line 2558 "sql_parse.c"
        break;
      case 125: /* selcollist ::= sclp STAR */
#line 453 "sql_parse.y"
{
  Expr *p = sqlite3Expr(pParse->db, TK_ALL, 0);
  yygotominor.yy322 = sqlite3ExprListAppend(pParse, yymsp[-1].minor.yy322, p);
}
#line 2566 "sql_parse.c"
        break;
      case 126: /* selcollist ::= sclp nm DOT STAR */
#line 457 "sql_parse.y"
{
...
#line 2576 "sql_parse.c"
        break;
      case 129: /* as ::= */
#line 470 "sql_parse.y"
{yygotominor.yy0.n = 0;}
#line 2581 "sql_parse.c"
        break;
      case 130: /* from ::= */
#line 482 "sql_parse.y"
{yygotominor.yy259 = sqlite3DbMallocZero(pParse->db, sizeof(*yygotominor.yy259));}
#line 2586 "sql_parse.c"
        break;
      case 131: /* from ::= FROM seltablist */
#line 483 "sql_parse.y"
{
  yygotominor.yy259 = yymsp[0].minor.yy259;
  sqlite3SrcListShiftJoinType(yygotominor.yy259);
}
#line 2594 "sql_parse.c"
        break;
      case 132: /* stl_prefix ::= seltablist joinop */
#line 491 "sql_parse.y"
{
...
#line 2602 "sql_parse.c"
        break;
      case 133: /* stl_prefix ::= */
#line 495 "sql_parse.y"
{yygotominor.yy259 = 0;}
#line 2607 "sql_parse.c"
        break;
      case 134: /* seltablist ::= stl_prefix nm dbnm as indexed_opt on_opt using_opt */
#line 496 "sql_parse.y"
{
  yygotominor.yy259 = sqlite3SrcListAppendFromTerm(pParse,yymsp[-6].minor.yy259,&yymsp[-5].minor.yy0,&yymsp[-4].minor.yy0,&yymsp[-3].minor.yy0,0,yymsp[-1].minor.yy314,yymsp[0].minor.yy384);
  sqlite3SrcListIndexedBy(pParse, yygotominor.yy259, &yymsp[-2].minor.yy0);
}
#line 2615 "sql_parse.c"
        break;
      case 135: /* seltablist ::= stl_prefix LP select RP as on_opt using_opt */
#line 502 "sql_parse.y"
{
    yygotominor.yy259 = sqlite3SrcListAppendFromTerm(pParse,yymsp[-6].minor.yy259,0,0,&yymsp[-2].minor.yy0,yymsp[-4].minor.yy387,yymsp[-1].minor.yy314,yymsp[0].minor.yy384);
  }
#line 2622 "sql_parse.c"
        break;
      case 136: /* seltablist ::= stl_prefix LP seltablist RP as on_opt using_opt */
#line 506 "sql_parse.y"
{
...
#line 2636 "sql_parse.c"
        break;
      case 137: /* dbnm ::= */
      case 146: /* indexed_opt ::= */ yytestcase(yyruleno==146);
#line 531 "sql_parse.y"
{yygotominor.yy0.z=0; yygotominor.yy0.n=0;}
#line 2642 "sql_parse.c"
        break;
      case 139: /* fullname ::= nm dbnm */
#line 536 "sql_parse.y"
{yygotominor.yy259 = sqlite3SrcListAppend(pParse->db,0,&yymsp[-1].minor.yy0,&yymsp[0].minor.yy0);}
#line 2647 "sql_parse.c"
        break;
      case 140: /* joinop ::= COMMA|JOIN */
#line 540 "sql_parse.y"
{ yygotominor.yy4 = JT_INNER; }
#line 2652 "sql_parse.c"
        break;
      case 141: /* joinop ::= JOIN_KW JOIN */
#line 541 "sql_parse.y"
{ yygotominor.yy4 = sqlite3JoinType(pParse,&yymsp[-1].minor.yy0,0,0); }
#line 2657 "sql_parse.c"
        break;
      case 142: /* joinop ::= JOIN_KW nm JOIN */
#line 542 "sql_parse.y"
{ yygotominor.yy4 = sqlite3JoinType(pParse,&yymsp[-2].minor.yy0,&yymsp[-1].minor.yy0,0); }
#line 2662 "sql_parse.c"
        break;
      case 143: /* joinop ::= JOIN_KW nm nm JOIN */
#line 544 "sql_parse.y"
{ yygotominor.yy4 = sqlite3JoinType(pParse,&yymsp[-3].minor.yy0,&yymsp[-2].minor.yy0,&yymsp[-1].minor.yy0); }
#line 2667 "sql_parse.c"
        break;
...
#line 548 "sql_parse.y"
{yygotominor.yy314 = yymsp[0].minor.yy118.pExpr;}
#line 2677 "sql_parse.c"
        break;
      case 145: /* on_opt ::= */
...
#line 2718 "sql_parse.c"
        break;
      case 154: /* sortlist ::= sortitem sortorder */
#line 585 "sql_parse.y"
{
...
#line 2870 "sql_parse.c"
        break;
      case 190: /* expr ::= nm DOT nm DOT nm */
#line 755 "sql_parse.y"
{
...
#line 2882 "sql_parse.c"
        break;
      case 193: /* expr ::= REGISTER */
#line 765 "sql_parse.y"
{
...
#line 2899 "sql_parse.c"
        break;
      case 194: /* expr ::= VARIABLE */
#line 778 "sql_parse.y"
{
  spanExpr(&yygotominor.yy118, pParse, TK_VARIABLE, &yymsp[0].minor.yy0);
  sqlite3ExprAssignVarNumber(pParse, yygotominor.yy118.pExpr);
  spanSet(&yygotominor.yy118, &yymsp[0].minor.yy0, &yymsp[0].minor.yy0);
}
#line 2908 "sql_parse.c"
        break;
      case 195: /* expr ::= expr COLLATE ids */
#line 783 "sql_parse.y"
{
...
#line 2939 "sql_parse.c"
        break;
      case 198: /* expr ::= ID LP STAR RP */
#line 804 "sql_parse.y"
{
  yygotominor.yy118.pExpr = sqlite3ExprFunction(pParse, 0, &yymsp[-3].minor.yy0);
  spanSet(&yygotominor.yy118,&yymsp[-3].minor.yy0,&yymsp[0].minor.yy0);
}
#line 2947 "sql_parse.c"
        break;
      case 199: /* term ::= CTIME_KW */
#line 808 "sql_parse.y"
{
...
#line 3013 "sql_parse.c"
        break;
      case 214: /* expr ::= expr ISNULL|NOTNULL */
#line 890 "sql_parse.y"
{spanUnaryPostfix(&yygotominor.yy118,pParse,yymsp[0].major,&yymsp[-1].minor.yy118,&yymsp[0].minor.yy0);}
#line 3018 "sql_parse.c"
        break;
      case 215: /* expr ::= expr NOT NULL */
#line 891 "sql_parse.y"
{spanUnaryPostfix(&yygotominor.yy118,pParse,TK_NOTNULL,&yymsp[-2].minor.yy118,&yymsp[0].minor.yy0);}
#line 3023 "sql_parse.c"
        break;
      case 216: /* expr ::= expr IS expr */
#line 912 "sql_parse.y"
{
  spanBinaryExpr(&yygotominor.yy118,pParse,TK_IS,&yymsp[-2].minor.yy118,&yymsp[0].minor.yy118);
  binaryToUnaryIfNull(pParse, yymsp[0].minor.yy118.pExpr, yygotominor.yy118.pExpr, TK_ISNULL);
}
#line 3031 "sql_parse.c"
        break;
      case 217: /* expr ::= expr IS NOT expr */
#line 916 "sql_parse.y"
{
  spanBinaryExpr(&yygotominor.yy118,pParse,TK_ISNOT,&yymsp[-3].minor.yy118,&yymsp[0].minor.yy118);
  binaryToUnaryIfNull(pParse, yymsp[0].minor.yy118.pExpr, yygotominor.yy118.pExpr, TK_NOTNULL);
}
#line 3039 "sql_parse.c"
        break;
      case 218: /* expr ::= NOT expr */
      case 219: /* expr ::= BITNOT expr */ yytestcase(yyruleno==219);
#line 939 "sql_parse.y"
{spanUnaryPrefix(&yygotominor.yy118,pParse,yymsp[-1].major,&yymsp[0].minor.yy118,&yymsp[-1].minor.yy0);}
#line 3045 "sql_parse.c"
        break;
      case 220: /* expr ::= MINUS expr */
#line 942 "sql_parse.y"
{spanUnaryPrefix(&yygotominor.yy118,pParse,TK_UMINUS,&yymsp[0].minor.yy118,&yymsp[-1].minor.yy0);}
#line 3050 "sql_parse.c"
        break;
      case 221: /* expr ::= PLUS expr */
#line 944 "sql_parse.y"
{spanUnaryPrefix(&yygotominor.yy118,pParse,TK_UPLUS,&yymsp[0].minor.yy118,&yymsp[-1].minor.yy0);}
#line 3055 "sql_parse.c"
        break;
      case 224: /* expr ::= expr between_op expr AND expr */
#line 949 "sql_parse.y"
{
...
#line 3072 "sql_parse.c"
        break;
      case 227: /* expr ::= expr in_op LP exprlist RP */
#line 966 "sql_parse.y"
{
...
#line 3101 "sql_parse.c"
        break;
      case 228: /* expr ::= LP select RP */
#line 991 "sql_parse.y"
{
...
#line 3117 "sql_parse.c"
        break;
      case 229: /* expr ::= expr in_op LP select RP */
#line 1003 "sql_parse.y"
{
    yygotominor.yy118.pExpr = sqlite3PExpr(pParse, TK_IN, yymsp[-4].minor.yy118.pExpr, 0, 0);
    if( yygotominor.yy118.pExpr ){
      yygotominor.yy118.pExpr->x.pSelect = yymsp[-1].minor.yy387;
...
#line 3134 "sql_parse.c"
        break;
      case 230: /* expr ::= expr in_op nm dbnm */
#line 1016 "sql_parse.y"
{
...
#line 3152 "sql_parse.c"
        break;
      case 231: /* expr ::= EXISTS LP select RP */
#line 1030 "sql_parse.y"
{
...
#line 3168 "sql_parse.c"
        break;
      case 232: /* expr ::= CASE case_operand case_exprlist case_else END */
#line 1045 "sql_parse.y"
{
...
#line 3183 "sql_parse.c"
        break;
      case 233: /* case_exprlist ::= case_exprlist WHEN expr THEN expr */
#line 1058 "sql_parse.y"
{
  yygotominor.yy322 = sqlite3ExprListAppend(pParse,yymsp[-4].minor.yy322, yymsp[-2].minor.yy118.pExpr);
  yygotominor.yy322 = sqlite3ExprListAppend(pParse,yygotominor.yy322, yymsp[0].minor.yy118.pExpr);
}
#line 3191 "sql_parse.c"
        break;
      case 234: /* case_exprlist ::= WHEN expr THEN expr */
#line 1062 "sql_parse.y"
{
  yygotominor.yy322 = sqlite3ExprListAppend(pParse,0, yymsp[-2].minor.yy118.pExpr);
  yygotominor.yy322 = sqlite3ExprListAppend(pParse,yygotominor.yy322, yymsp[0].minor.yy118.pExpr);
}
#line 3199 "sql_parse.c"
        break;
      case 243: /* cmd ::= createkw uniqueflag INDEX ifnotexists nm dbnm ON nm LP idxlist RP */
#line 1091 "sql_parse.y"
{
...
#line 3208 "sql_parse.c"
        break;
      case 244: /* uniqueflag ::= UNIQUE */
      case 298: /* raisetype ::= ABORT */ yytestcase(yyruleno==298);
#line 1098 "sql_parse.y"
{yygotominor.yy4 = OE_Abort;}
#line 3214 "sql_parse.c"
        break;
      case 245: /* uniqueflag ::= */
#line 1099 "sql_parse.y"
{yygotominor.yy4 = OE_None;}
#line 3219 "sql_parse.c"
        break;
      case 248: /* idxlist ::= idxlist COMMA nm collate sortorder */
#line 1108 "sql_parse.y"
{
  Expr *p = 0;
...
#line 3234 "sql_parse.c"
        break;
      case 249: /* idxlist ::= nm collate sortorder */
#line 1119 "sql_parse.y"
{
  Expr *p = 0;
  if( yymsp[-1].minor.yy0.n>0 ){
...
#line 3249 "sql_parse.c"
        break;
      case 250: /* collate ::= */
#line 1132 "sql_parse.y"
{yygotominor.yy0.z = 0; yygotominor.yy0.n = 0;}
#line 3254 "sql_parse.c"
        break;
      case 252: /* cmd ::= DROP INDEX ifexists fullname */
#line 1138 "sql_parse.y"
{sqlite3DropIndex(pParse, yymsp[0].minor.yy259, yymsp[-1].minor.yy4);}
#line 3259 "sql_parse.c"
        break;
      case 253: /* cmd ::= VACUUM */
      case 254: /* cmd ::= VACUUM nm */ yytestcase(yyruleno==254);
#line 1144 "sql_parse.y"
{sqlite3Vacuum(pParse);}
#line 3265 "sql_parse.c"
        break;
      case 255: /* cmd ::= PRAGMA nm dbnm */
#line 1152 "sql_parse.y"
{sqlite3Pragma(pParse,&yymsp[-1].minor.yy0,&yymsp[0].minor.yy0,0,0);}
#line 3270 "sql_parse.c"
        break;
      case 256: /* cmd ::= PRAGMA nm dbnm EQ nmnum */
#line 1153 "sql_parse.y"
{sqlite3Pragma(pParse,&yymsp[-3].minor.yy0,&yymsp[-2].minor.yy0,&yymsp[0].minor.yy0,0);}
#line 3275 "sql_parse.c"
        break;
      case 257: /* cmd ::= PRAGMA nm dbnm LP nmnum RP */
#line 1154 "sql_parse.y"
{sqlite3Pragma(pParse,&yymsp[-4].minor.yy0,&yymsp[-3].minor.yy0,&yymsp[-1].minor.yy0,0);}
#line 3280 "sql_parse.c"
        break;
      case 258: /* cmd ::= PRAGMA nm dbnm EQ minus_num */
#line 1156 "sql_parse.y"
{sqlite3Pragma(pParse,&yymsp[-3].minor.yy0,&yymsp[-2].minor.yy0,&yymsp[0].minor.yy0,1);}
#line 3285 "sql_parse.c"
        break;
      case 259: /* cmd ::= PRAGMA nm dbnm LP minus_num RP */
#line 1158 "sql_parse.y"
{sqlite3Pragma(pParse,&yymsp[-4].minor.yy0,&yymsp[-3].minor.yy0,&yymsp[-1].minor.yy0,1);}
#line 3290 "sql_parse.c"
        break;
      case 270: /* cmd ::= createkw trigger_decl BEGIN trigger_cmd_list END */
#line 1176 "sql_parse.y"
{
  Token all;
...
#line 3300 "sql_parse.c"
        break;
      case 271: /* trigger_decl ::= temp TRIGGER ifnotexists nm dbnm trigger_time trigger_event ON fullname foreach_clause when_clause */
#line 1185 "sql_parse.y"
{
  sqlite3BeginTrigger(pParse, &yymsp[-7].minor.yy0, &yymsp[-6].minor.yy0, yymsp[-5].minor.yy4, yymsp[-4].minor.yy90.a, yymsp[-4].minor.yy90.b, yymsp[-2].minor.yy259, yymsp[0].minor.yy314, yymsp[-10].minor.yy4, yymsp[-8].minor.yy4);
  yygotominor.yy0 = (yymsp[-6].minor.yy0.n==0?yymsp[-7].minor.yy0:yymsp[-6].minor.yy0);
}
#line 3308 "sql_parse.c"
        break;
      case 272: /* trigger_time ::= BEFORE */
      case 275: /* trigger_time ::= */ yytestcase(yyruleno==275);
#line 1191 "sql_parse.y"
{ yygotominor.yy4 = TK_BEFORE; }
#line 3314 "sql_parse.c"
        break;
      case 273: /* trigger_time ::= AFTER */
#line 1192 "sql_parse.y"
{ yygotominor.yy4 = TK_AFTER;  }
#line 3319 "sql_parse.c"
        break;
      case 274: /* trigger_time ::= INSTEAD OF */
#line 1193 "sql_parse.y"
{ yygotominor.yy4 = TK_INSTEAD;}
#line 3324 "sql_parse.c"
        break;
      case 276: /* trigger_event ::= DELETE|INSERT */
      case 277: /* trigger_event ::= UPDATE */ yytestcase(yyruleno==277);
#line 1198 "sql_parse.y"
{yygotominor.yy90.a = yymsp[0].major; yygotominor.yy90.b = 0;}
#line 3330 "sql_parse.c"
        break;
      case 278: /* trigger_event ::= UPDATE OF inscollist */
#line 1200 "sql_parse.y"
{yygotominor.yy90.a = TK_UPDATE; yygotominor.yy90.b = yymsp[0].minor.yy384;}
#line 3335 "sql_parse.c"
        break;
      case 281: /* when_clause ::= */
      case 303: /* key_opt ::= */ yytestcase(yyruleno==303);
#line 1207 "sql_parse.y"
{ yygotominor.yy314 = 0; }
#line 3341 "sql_parse.c"
        break;
      case 282: /* when_clause ::= WHEN expr */
      case 304: /* key_opt ::= KEY expr */ yytestcase(yyruleno==304);
#line 1208 "sql_parse.y"
{ yygotominor.yy314 = yymsp[0].minor.yy118.pExpr; }
#line 3347 "sql_parse.c"
        break;
      case 283: /* trigger_cmd_list ::= trigger_cmd_list trigger_cmd SEMI */
#line 1212 "sql_parse.y"
{
...
#line 3357 "sql_parse.c"
        break;
      case 284: /* trigger_cmd_list ::= trigger_cmd SEMI */
#line 1218 "sql_parse.y"
{ 
  assert( yymsp[-1].minor.yy203!=0 );
  yymsp[-1].minor.yy203->pLast = yymsp[-1].minor.yy203;
  yygotominor.yy203 = yymsp[-1].minor.yy203;
}
#line 3366 "sql_parse.c"
        break;
      case 286: /* trnm ::= nm DOT nm */
#line 1230 "sql_parse.y"
{
  yygotominor.yy0 = yymsp[0].minor.yy0;
...
#line 3376 "sql_parse.c"
        break;
      case 288: /* tridxby ::= INDEXED BY nm */
#line 1242 "sql_parse.y"
{
  sqlite3ErrorMsg(pParse,
        "the INDEXED BY clause is not allowed on UPDATE or DELETE statements "
        "within triggers");
}
#line 3385 "sql_parse.c"
        break;
      case 289: /* tridxby ::= NOT INDEXED */
#line 1247 "sql_parse.y"
{
  sqlite3ErrorMsg(pParse,
        "the NOT INDEXED clause is not allowed on UPDATE or DELETE statements "
        "within triggers");
}
#line 3394 "sql_parse.c"
        break;
      case 290: /* trigger_cmd ::= UPDATE orconf trnm tridxby SET setlist where_opt */
#line 1260 "sql_parse.y"
...
#line 3399 "sql_parse.c"
        break;
      case 291: /* trigger_cmd ::= insert_cmd INTO trnm inscollist_opt VALUES LP itemlist RP */
#line 1265 "sql_parse.y"
...
#line 3404 "sql_parse.c"
        break;
      case 292: /* trigger_cmd ::= insert_cmd INTO trnm inscollist_opt select */
#line 1268 "sql_parse.y"
...
#line 3409 "sql_parse.c"
        break;
      case 293: /* trigger_cmd ::= DELETE FROM trnm tridxby where_opt */
#line 1272 "sql_parse.y"
{yygotominor.yy203 = sqlite3TriggerDeleteStep(pParse->db, &yymsp[-2].minor.yy0, yymsp[0].minor.yy314);}
#line 3414 "sql_parse.c"
        break;
      case 294: /* trigger_cmd ::= select */
#line 1275 "sql_parse.y"
{yygotominor.yy203 = sqlite3TriggerSelectStep(pParse->db, yymsp[0].minor.yy387); }
#line 3419 "sql_parse.c"
        break;
      case 295: /* expr ::= RAISE LP IGNORE RP */
#line 1278 "sql_parse.y"
{
...
#line 3431 "sql_parse.c"
        break;
      case 296: /* expr ::= RAISE LP raisetype COMMA nm RP */
#line 1286 "sql_parse.y"
{
...
#line 3443 "sql_parse.c"
        break;
      case 297: /* raisetype ::= ROLLBACK */
#line 1297 "sql_parse.y"
{yygotominor.yy4 = OE_Rollback;}
#line 3448 "sql_parse.c"
        break;
      case 299: /* raisetype ::= FAIL */
#line 1299 "sql_parse.y"
{yygotominor.yy4 = OE_Fail;}
#line 3453 "sql_parse.c"
        break;
      case 300: /* cmd ::= DROP TRIGGER ifexists fullname */
#line 1304 "sql_parse.y"
{
  sqlite3DropTrigger(pParse,yymsp[0].minor.yy259,yymsp[-1].minor.yy4);
}
#line 3460 "sql_parse.c"
        break;
      case 301: /* cmd ::= ATTACH database_kw_opt expr AS expr key_opt */
#line 1311 "sql_parse.y"
{
  sqlite3Attach(pParse, yymsp[-3].minor.yy118.pExpr, yymsp[-1].minor.yy118.pExpr, yymsp[0].minor.yy314);
}
#line 3467 "sql_parse.c"
        break;
      case 302: /* cmd ::= DETACH database_kw_opt expr */
#line 1314 "sql_parse.y"
{
  sqlite3Detach(pParse, yymsp[0].minor.yy118.pExpr);
}
#line 3474 "sql_parse.c"
        break;
      case 307: /* cmd ::= REINDEX */
#line 1329 "sql_parse.y"
{sqlite3Reindex(pParse, 0, 0);}
#line 3479 "sql_parse.c"
        break;
      case 308: /* cmd ::= REINDEX nm dbnm */
#line 1330 "sql_parse.y"
{sqlite3Reindex(pParse, &yymsp[-1].minor.yy0, &yymsp[0].minor.yy0);}
#line 3484 "sql_parse.c"
        break;
      case 309: /* cmd ::= ANALYZE */
#line 1335 "sql_parse.y"
{sqlite3Analyze(pParse, 0, 0);}
#line 3489 "sql_parse.c"
        break;
      case 310: /* cmd ::= ANALYZE nm dbnm */
#line 1336 "sql_parse.y"
{sqlite3Analyze(pParse, &yymsp[-1].minor.yy0, &yymsp[0].minor.yy0);}
#line 3494 "sql_parse.c"
        break;
      case 311: /* cmd ::= ALTER TABLE fullname RENAME TO nm */
#line 1341 "sql_parse.y"
{
  sqlite3AlterRenameTable(pParse,yymsp[-3].minor.yy259,&yymsp[0].minor.yy0);
}
#line 3501 "sql_parse.c"
        break;
      case 312: /* cmd ::= ALTER TABLE add_column_fullname ADD kwcolumn_opt column */
#line 1344 "sql_parse.y"
{
  sqlite3AlterFinishAddColumn(pParse, &yymsp[0].minor.yy0);
}
#line 3508 "sql_parse.c"
        break;
      case 313: /* add_column_fullname ::= fullname */
#line 1347 "sql_parse.y"
{
  pParse->db->lookaside.bEnabled = 0;
  sqlite3AlterBeginAddColumn(pParse, yymsp[0].minor.yy259);
}
#line 3516 "sql_parse.c"
        break;
      case 316: /* cmd ::= create_vtab */
#line 1357 "sql_parse.y"
{sqlite3VtabFinishParse(pParse,0);}
#line 3521 "sql_parse.c"
        break;
      case 317: /* cmd ::= create_vtab LP vtabarglist RP */
#line 1358 "sql_parse.y"
{sqlite3VtabFinishParse(pParse,&yymsp[0].minor.yy0);}
#line 3526 "sql_parse.c"
        break;
      case 318: /* create_vtab ::= createkw VIRTUAL TABLE nm dbnm USING nm */
#line 1359 "sql_parse.y"
{
    sqlite3VtabBeginParse(pParse, &yymsp[-3].minor.yy0, &yymsp[-2].minor.yy0, &yymsp[0].minor.yy0);
}
#line 3533 "sql_parse.c"
        break;
      case 321: /* vtabarg ::= */
#line 1364 "sql_parse.y"
{sqlite3VtabArgInit(pParse);}
#line 3538 "sql_parse.c"
        break;
      case 323: /* vtabargtoken ::= ANY */
      case 324: /* vtabargtoken ::= lp anylist RP */ yytestcase(yyruleno==324);
      case 325: /* lp ::= LP */ yytestcase(yyruleno==325);
#line 1366 "sql_parse.y"
{sqlite3VtabArgExtend(pParse,&yymsp[0].minor.yy0);}
#line 3545 "sql_parse.c"
        break;
      default:
